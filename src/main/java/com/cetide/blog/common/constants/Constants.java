...
public interface Constants {
     ...
     * 直播状态标识,直播未开始
     */
    String LIVE_NOT_STARTED = "0";

    /**
     * 直播状态标识,直播进行中
     */
    String LIVE_IN_PROGRESS = "1";
     ...
     * 视频显示状态1 表示显示
     */
    String VIDEO_STATE_SHOW = "1";

    /**
     * 视频显示状态0 表示隐藏
     */
    String VIDEO_STATE_HIDE = "0";

    String LIVE_RESERVE = "0";

    String PROMPTLY_REFRESH_CODE = "refresh";
